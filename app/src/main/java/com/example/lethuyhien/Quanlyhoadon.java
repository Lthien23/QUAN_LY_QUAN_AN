        ...
        na.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.item4) {
                    Intent intent4 = new Intent(Quanlyhoadon.this, Quanlynhanvien.class);
                    startActivity(intent4);
                }  else if (itemId == R.id.item5) {
                    Intent intent5 = new Intent(Quanlyhoadon.this, Quanlymonan.class);
                    startActivity(intent5);
                }else if (itemId == R.id.item6) {
                    Intent intent6 = new Intent(Quanlyhoadon.this, Quanlyhoadon.class);
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.item1) {
                    Intent intent4 = new Intent(Quanlyhoadon.this, Trangchu.class);
                    startActivity(intent4);
                }  else if (itemId == R.id.item2) {
                    Intent intent5 = new Intent(Quanlyhoadon.this, menu_monan.class);
                    startActivity(intent5);
                }else if (itemId == R.id.item3) {
                    Intent intent6 = new Intent(Quanlyhoadon.this, Hoadon.class);
                    startActivity(intent6);
                } else if (itemId == R.id.item4) {
                    Intent intent7 = new Intent(Quanlyhoadon.this, thong_ke.class);
        ...
        builder.setTitle("Xác nhận đăng xuất")
                ...
                .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(Quanlyhoadon.this, Dangnhap.class);
